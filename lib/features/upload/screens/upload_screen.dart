...
//                       return _buildSelectedFilesList(controller);
//                     }),
...
//                   ),
//                   child: Text(
//                     '${controller.selectedFiles.length}/$UploadController.maxFiles ${'files'.tr}',
//                     style: TextStyle(
//                       color: AppColors.textSubtle,
//                       fontSize: 12.sp,
...
//   //  Selected Files List
//   // ══════════════════════════════════════
//   Widget _buildSelectedFilesList(UploadController controller) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Row(
...
//         // File items
//         ...List.generate(controller.selectedFiles.length, (index) {
...
//   Widget _buildFileItem(UploadController controller, int index) {
