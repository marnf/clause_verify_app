...
//           // ══════════════════════════════════════
//           Obx(() {
//             if (!controller.hasFiles || !controller.isImageMode) return const SizedBox.shrink();
...
//           padding: const EdgeInsets.all(2), // ✅ Added small padding so border is clearly visible
//           child: Container(
...
//                     final typeStr = controller.isDocumentMode.value == true ? 'documentText'.tr : 'filesText'.tr;
//                     return Text(
//                       '$count/$max $typeStr',
//                       style: TextStyle(
//                         color: AppColors.textSubtle,
...
//               ),
//               child: Text(
//                 'pageNumber'.trParams({'number': (index + 1).toString()}),
//                 style: TextStyle(
//                   color: Colors.white,
//                   fontSize: 12.sp,
//                   fontWeight: FontWeight.w500,
...
//         children: [
//           Text(
//             'photosAdded'.trParams({'count': count.toString(), 'total': total.toString()}),
//             style: TextStyle(
//               color: AppColors.textSubtle,
//               fontSize: 12.sp,
//               fontWeight: FontWeight.w500,
...
//           if (remaining > 0)
//             Text(
//               'remainingPhotos'.trParams({'remaining': remaining.toString()}),
//               style: TextStyle(
//                 color: AppColors.primaryColor,
//                 fontSize: 12.sp,
//                 fontWeight: FontWeight.w600,
...
class UploadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 👇👇👇 নতুন যোগ করা: Stack দিয়ে ঘিরে দেওয়া হয়েছে যাতে overlay দেখানো যায়
      body: Stack(
        children: [
          Column(
            children: [
          ...
          // 👇👇👇 নতুন যোগ করা: Image pick/convert হওয়ার সময় full-screen overlay
          Obx(() {
              ...
              child: isUploading
                  ? Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10.w),
                        Text(
                          // 👇 পরিবর্তন করা হয়েছে: 'uploading' -> 'analysing'
                          'analysing'.tr,
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 16.sp,
