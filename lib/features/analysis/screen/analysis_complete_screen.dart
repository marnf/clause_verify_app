...
import 'package:flutter_extension/features/analysis/controller/analysis_conplete_controller.dart';
...
class AnalysisCompleteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(AnalysisConpleteController());
    ...
    return Padding(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(title: 'analysisComplete'.tr,onIconTap: (){
  ...
  Widget _buildAuthenticityEvaluation(AnalysisConpleteController controller) {
    return Obx(
      () => Container(
        decoration: BoxDecoration(
          color: Colors.black,
  ...
  Widget _buildCategoryAnalysis(AnalysisConpleteController controller) {
    return Obx(
      () => Container(
        decoration: BoxDecoration(
  ...
  Widget _buildExpertCommentary(AnalysisConpleteController controller) {
    return Obx(
      () => Container(
        decoration: BoxDecoration(
          color: Color(0xFF0D0D0D),
