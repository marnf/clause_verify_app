...
class TermsOfUseController extends GetxController {
  List<TermsSection> get sections => [
    TermsSection(
      ...
      content: 'clauseverify provides an AI-based watch pre-expertise service allowing users to upload images of watches in order to receive an AI Pre-Expertise Report.\n\nThe Service is designed to provide informational insights only, based on automated artificial intelligence analysis.'.tr,
    ),
    TermsSection(
    ...
    TermsSection(
      ...
      content: '• Users must be 18 years or older\n• By using clauseverify, you confirm you have legal capacity and authority to use the Service'.tr,
    ),
    TermsSection(
